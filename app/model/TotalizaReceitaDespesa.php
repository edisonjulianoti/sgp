...
class TotalizaReceitaDespesa extends TRecord
{
    const TABLENAME  = 'totaliza_receita_despesa';
    const PRIMARYKEY = 'id';
    ...
    public function getCategorias()
    {
        ...
        $criteria->add(new TFilter('totaliza_receita_despesa_id', '=', $this->id));
    ...
    public function get_categoria_tipo_categoria_to_string()
    {
        ...
        $values = Categoria::where('totaliza_receita_despesa_id', '=', $this->id)->getIndexedArray('tipo_categoria_id','{tipo_categoria->id}');
    ...
    public function get_categoria_totaliza_receita_despesa_to_string()
    {
        ...
        $values = Categoria::where('totaliza_receita_despesa_id', '=', $this->id)->getIndexedArray('totaliza_receita_despesa_id','{totaliza_receita_despesa->id}');
        return implode(', ', $values);
    }
    ...
    public function get_categoria_system_users_to_string()
    {
        ...
        $values = Categoria::where('totaliza_receita_despesa_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
