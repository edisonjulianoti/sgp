...
class Recorrencia extends TRecord
{
    const TABLENAME  = 'recorrencia';
    const PRIMARYKEY = 'id';
    const IDPOLICY   =  'serial'; // {max, serial}

    const SEMRECORRENCIA = '1';
    const DIARIO = '2';
    const SEMANAL = '3';
    const MENSAL = '4';
    const ANUAL = '5';
    ...
    const TRIMESTRAL = '7';
    const SEMESTRAL = '8';
    const DIAESPECIFICO = '9';
    const PERSONALIZADA = '10';
    ...
    public function getAgendamentos()
    {
        ...
        $criteria->add(new TFilter('recorrencia_id', '=', $this->id));
    ...
    public function get_agendamento_relevancia_to_string()
    {
        ...
        $values = Agendamento::where('recorrencia_id', '=', $this->id)->getIndexedArray('relevancia_id','{relevancia->descricao}');
    ...
    public function get_agendamento_recorrencia_to_string()
    {
        ...
        $values = Agendamento::where('recorrencia_id', '=', $this->id)->getIndexedArray('recorrencia_id','{recorrencia->id}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_plano_to_string()
    {
        ...
        $values = Agendamento::where('recorrencia_id', '=', $this->id)->getIndexedArray('plano_id','{plano->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_tipo_to_string()
    {
        ...
        $values = Agendamento::where('recorrencia_id', '=', $this->id)->getIndexedArray('tipo_id','{tipo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_considera_final_semana_to_string()
    {
        ...
        $values = Agendamento::where('recorrencia_id', '=', $this->id)->getIndexedArray('considera_final_semana_id','{considera_final_semana->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_lembrete_agenda_to_string()
    {
        ...
        $values = Agendamento::where('recorrencia_id', '=', $this->id)->getIndexedArray('lembrete_agenda_id','{lembrete_agenda->id}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_system_users_to_string()
    {
        ...
        $values = Agendamento::where('recorrencia_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
