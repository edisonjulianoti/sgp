...
class Setor extends TRecord
{
    ...
    public function get_atendimento_tipo_atendimento_to_string()
    {
        ...
        $values = Atendimento::where('setor_id', '=', $this->id)->getIndexedArray('tipo_atendimento_id','{tipo_atendimento->nome}');
    ...
    public function get_atendimento_setor_to_string()
    {
        ...
        $values = Atendimento::where('setor_id', '=', $this->id)->getIndexedArray('setor_id','{setor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_atendimento_cliente_to_string()
    {
        ...
        $values = Atendimento::where('setor_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_atendimento_cliente_usuario_to_string()
    {
        ...
        $values = Atendimento::where('setor_id', '=', $this->id)->getIndexedArray('cliente_usuario_id','{cliente_usuario->id}');
        return implode(', ', $values);
    }
    ...
    public function get_atendimento_atendente_to_string()
    {
        ...
        $values = Atendimento::where('setor_id', '=', $this->id)->getIndexedArray('atendente_id','{atendente->id}');
        return implode(', ', $values);
    }
    ...
    public function get_setor_atendente_setor_to_string()
    {
        ...
        $values = SetorAtendente::where('setor_id', '=', $this->id)->getIndexedArray('setor_id','{setor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_setor_atendente_atendente_to_string()
    {
        ...
        $values = SetorAtendente::where('setor_id', '=', $this->id)->getIndexedArray('atendente_id','{atendente->id}');
        return implode(', ', $values);
    }
