...
class StatusLancamento extends TRecord
{
    const TABLENAME  = 'status_lancamento';
    const PRIMARYKEY = 'id';
    ...
    public function getLancamentos()
    {
        ...
        $criteria->add(new TFilter('status_lancamento_id', '=', $this->id));
    ...
    public function get_lancamento_categoria_to_string()
    {
        ...
        $values = Lancamento::where('status_lancamento_id', '=', $this->id)->getIndexedArray('categoria_id','{categoria->descricao}');
    ...
    public function get_lancamento_conta_to_string()
    {
        ...
        $values = Lancamento::where('status_lancamento_id', '=', $this->id)->getIndexedArray('conta_id','{conta->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_lancamento_status_lancamento_to_string()
    {
        ...
        $values = Lancamento::where('status_lancamento_id', '=', $this->id)->getIndexedArray('status_lancamento_id','{status_lancamento->id}');
        return implode(', ', $values);
    }
    ...
    public function get_lancamento_system_users_to_string()
    {
        ...
        $values = Lancamento::where('status_lancamento_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
    ...
    public function get_lancamento_tipo_lancamento_to_string()
    {
        ...
        $values = Lancamento::where('status_lancamento_id', '=', $this->id)->getIndexedArray('tipo_lancamento_id','{tipo_lancamento->id}');
        return implode(', ', $values);
    }
