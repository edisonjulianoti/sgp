...
class Tipo extends TRecord
{
    ...
    public function get_agendamento_relevancia_to_string()
    {
        ...
        $values = Agendamento::where('tipo_id', '=', $this->id)->getIndexedArray('relevancia_id','{relevancia->descricao}');
    ...
    public function get_agendamento_recorrencia_to_string()
    {
        ...
        $values = Agendamento::where('tipo_id', '=', $this->id)->getIndexedArray('recorrencia_id','{recorrencia->id}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_plano_to_string()
    {
        ...
        $values = Agendamento::where('tipo_id', '=', $this->id)->getIndexedArray('plano_id','{plano->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_tipo_to_string()
    {
        ...
        $values = Agendamento::where('tipo_id', '=', $this->id)->getIndexedArray('tipo_id','{tipo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_considera_final_semana_to_string()
    {
        ...
        $values = Agendamento::where('tipo_id', '=', $this->id)->getIndexedArray('considera_final_semana_id','{considera_final_semana->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_lembrete_agenda_to_string()
    {
        ...
        $values = Agendamento::where('tipo_id', '=', $this->id)->getIndexedArray('lembrete_agenda_id','{lembrete_agenda->id}');
        return implode(', ', $values);
    }
    ...
    public function get_agendamento_system_users_to_string()
    {
        ...
        $values = Agendamento::where('tipo_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
    ...
    public function get_tarefa_plano_to_string()
    {
        ...
        $values = Tarefa::where('tipo_id', '=', $this->id)->getIndexedArray('plano_id','{plano->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_tarefa_status_tarefa_to_string()
    {
        ...
        $values = Tarefa::where('tipo_id', '=', $this->id)->getIndexedArray('status_tarefa_id','{status_tarefa->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_tarefa_relevancia_to_string()
    {
        ...
        $values = Tarefa::where('tipo_id', '=', $this->id)->getIndexedArray('relevancia_id','{relevancia->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_tarefa_tipo_to_string()
    {
        ...
        $values = Tarefa::where('tipo_id', '=', $this->id)->getIndexedArray('tipo_id','{tipo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_tarefa_system_users_to_string()
    {
        ...
        $values = Tarefa::where('tipo_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
