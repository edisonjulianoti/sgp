...
class TemplateEmailHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_TemplateEmail';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit = new TDataGridAction(array('TemplateEmailForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TemplateEmailHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de templates de email");
        ...
        $button_cadastrar->setAction(new TAction(['TemplateEmailForm', 'onShow']), "Cadastrar");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Rotinas","Templates de email"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TemplateEmail($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TemplateEmail
