...
class AtendimentoTrocarSetorForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_AtendimentoTrocarSetorForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Formulário de troca de setor de atendimento");
        ...
        $row1 = $this->form->addFields([new TLabel("Código do atendimento:", null, '14px', null, '100%'),$id]);
        $row1->layout = [' col-sm-12'];

        $row2 = $this->form->addFields([new TLabel("Setor:", '#ff0000', '14px', null, '100%'),$setor_id]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $messageAction = new TAction(['AtendimentoList', 'onShow']);   
