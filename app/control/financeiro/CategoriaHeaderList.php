...
class CategoriaHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $tipo_categoria_id = new TDBCombo('tipo_categoria_id', 'bd_sgp', 'TipoCategoria', 'id', '{descricao}','id asc'  );
        $totaliza_receita_despesa_id = new TDBCombo('totaliza_receita_despesa_id', 'bd_sgp', 'TotalizaReceitaDespesa', 'id', '{descricao}','id asc'  );
