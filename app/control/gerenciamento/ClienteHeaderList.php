...
class ClienteHeaderList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $action_onDelete = new TDataGridAction(array('ClienteHeaderList', 'onDelete'));
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['ClienteHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ClienteHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['ClienteHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['ClienteHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Gerenciamento","Clientes"]));
        }
