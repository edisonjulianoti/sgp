...
class LinkUtilHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_LinkUtil';
    ...
    public function __construct($param = null)
    {
        ...
        $link->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1', 'target_container' => $param['target_container'] ?? null]));
        ...
        $action_onEdit = new TDataGridAction(array('LinkUtilForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('LinkUtilHeaderList', 'onDelete'));
        ...
        $this->datagrid_form->addField($link);
        ...
        $panel = new TPanelGroup("Listagem de links");
        ...
        $button_cadastrar->setAction(new TAction(['LinkUtilForm', 'onShow']), "Cadastrar");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Gerenciamento","Links"]));
        }
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->link) AND ( (is_scalar($data->link) AND $data->link !== '') OR (is_array($data->link) AND (!empty($data->link)) )) )
        {

            $filters[] = new TFilter('link', 'like', "%{$data->link}%");// create the filter 
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for LinkUtil
