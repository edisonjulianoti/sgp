...
class TipoDocumentoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['TipoDocumentoHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('TipoDocumentoHeaderList', 'onShow', $loadPageParam); 
